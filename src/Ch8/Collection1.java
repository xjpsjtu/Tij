...
public class Collection1 {
	...
	public static Collection newCollection(){
		...
		//ArrayList is used for simplicity, but it's only seen as a generic Collection
	...
	public static void main(String[] args) {
		...
		//Find max and min elements;this means different things depending on the way the 
		...
		print(c);
		//Remove all compnents that are in the arguments collection:
		...
		//Keep all the elements that are in both c and c2(an intersection of sets):
		c.retainAll(c2);
		print(c);
