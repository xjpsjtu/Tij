package Ch13;
//:Menus.java
//A menu-building system; also demonstreates icons in labels and menu items.
import java.awt.*;
...
public class Menus extends JPanel{
	...
	static final MType
		...
		rb = new MType(3);	//Radio buton menu item
	...
	public Object[][] optionMenu = {
		//Menu name;
		{"Options", new Character('0')},
		//Name type accle listener enabled
	...
	public Object[] MenuBar = {
		fileMenu, editMenu, faceMenu, optionMenu, helpMenu,
	};
