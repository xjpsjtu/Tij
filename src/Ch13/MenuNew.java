...
public class MenuNew extends Frame{
	...
	TextField t = new TextField("No falvor", 30);
	...
	class ML implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(actionCommand.equals("Open")){
				...
				if(!chosen)t.setText("Choose a falvor first");
				else
	...
	//Alternatively, you can create a different class for each different MenuItem. Then you don't have to figure out which one it is:
	...
	class CMIL implements ItemListener{
		...
		public void itemStateChanged(ItemEvent e) {
			...
			if(actionCommand.equals("Guard"))
				t.setText("Guard teh Ice Cream! "+"Guarding is "+target.getState());
			else if(actionCommand.equals("Hide"))
				t.setText("Hide the Ice cream! "+"Is it cold? "+target.getState());
		}
