...
public class PrintDemo extends Frame{
	...
	Button printGraphics = new Button("Print Graphics");
	...
	class Plot2 extends Plot{
		//To fit the picture to the page, you must know whether you're printing or painting:
		public void paint(Graphics g){
			int w,h;
	...
	class Plot3 extends Plot{
		//Somewhat better. Separate printing from painting:
		public void print(Graphics g){
			//Assuming it's a PrintGraphics object:
			PrintJob pj = ((PrintGraphics)g).getPrintJob();
