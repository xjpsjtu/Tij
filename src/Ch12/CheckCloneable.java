...
//Turning off cloning by throwing the exception:
...
class BackOn extends NoMore{
	private BackOn duplicate(BackOn b){
		...
		//and return that copy. This is a dummy copy, just to make the point:
		return new BackOn();
	}
	public Object clone(){
...
public class CheckCloneable {
	...
	public static void main(String[] args) {
		...
		//This won't compile, since clone() is protected in Object:
		//x = (Ordinary)x.clone();
		//tryToClone() checks first to see if a class implements Cloneable:
