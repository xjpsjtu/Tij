package Ch16.dynatrash;
//:DynaTrash.java
//Using a Hashtable of Vectors and RTTI to automatically sort trash into vectors. This soution, despite
...
class TypeMap{
	...
	//Returns handle to adapter class to allow callbacks from ParseTrash.fillBin()
...
public class DynaTrash {
	public static void main(String[] args){
		...
		ParseTrash.fillBin("Trash.txt", bin.filler());
