...
public class BangBean2 extends Canvas implements Serializable{
	...
	//This is a multicast listener, which is more typically used than the unicast approach taken in BangBean.java
	...
	public void notifyListeners(){
		...
		Vector lv = null;
		//Make a copy of the vector in case someone adds a listener while we're calling listeners:
		synchronized(this){
